        ...
        <tr>
            <td align="center" valign="top" bgcolor="#ffffff" width="100%">
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                        <td background="https://i.ibb.co/YR5L4jN/adorable-1868871-1280.jpg" bgcolor="#0d0102" valign="top" style="background: url(https://i.ibb.co/YR5L4jN/adorable-1868871-1280.jpg) no-repeat center; background-color: #0d0102; background-position: center;">
                            <!--[if gte mso 9]>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%">
                                                            <tr>
                                                                ...
                                                                <td class="mobile-block mobile-padding" style="text-align:justify;">
                                                                    ...
                                                                    Oficialmente eres parte de Ardogs, alguien de nuestro equipo atendio a tu solicitud y nos contó
                                                                    solo cosas buenas de ti, por lo que ahora te queremos dar la bienvenida de manera oficial. <br><br>

                                                                    Sabemos que el camino fue muy largo, pero piensa en esto: ¡No cualquiera esta en Ardogs!,
                                                                    ahora visita <a href="https://ardogs.herokuapp.com">Ardogs.com</a>, ya sabes que hacer.
                                                ...
                                                <table style="margin:0 auto;" cellspacing="0" cellpadding="5" width="100%">
                                                    <tr>
                                                        <td style="text-align:center; margin:0 auto;" width="100%">
                                                            <a href="https://ardogs.herokuapp.com" style="text-align:center;">
