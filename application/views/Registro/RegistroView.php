...
<div class="container">
    ...
    <div id="test-swipe-1" class="col m12 s12">
        ...
        <ul class="stepper horizontal linear demos" id="horizontal">
            <li class="step">
                <div data-step-label="personal" class="step-title waves-effect waves-dark">Información</div>
            ...
            <li class="step" id="li1">
                <div data-step-label="inicio de sesión" class="step-title waves-effect waves-dark">Información de</div>
    ...
    <div id="test-swipe-2" class="col m12 s12">
        ...
        ?>
        <ul class="stepper horizontal linear demos_1" id="horizontal">
            <li class="step">
                <div data-step-label="personal" class="step-title waves-effect waves-dark">Información</div>
            ...
            <li class="step">
                <div data-step-label="inicio de sesión" class="step-title waves-effect waves-dark">Informacion de</div>
            ...
            <li class="step">
                <div data-step-label="centro de adopción" class="step-title waves-effect waves-dark">Información del</div>
...
<script type="text/javascript" src="<?php echo base_url("Estilos/lib/entropizer.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("Estilos/dist/js/jquery-entropizer.min.js"); ?>"></script>
...
<script>
    var stepper = document.querySelector('.stepper.demos_1');
    var stepperInstace = new MStepper(stepper, {
        firstActive: 0
    });
</script>
