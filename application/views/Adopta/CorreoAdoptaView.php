                                                ...
                                                <table style="margin: 0 auto;" cellspacing="0" cellpadding="8" width="180">
                                                    <tr>
                                                        ...
                                                        <td style="width:150px; height:33px; background-color: #212121;">
                                                            <div>
                                                                <a href=<?php echo $link?> style="background-color:#212121;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Comprobante</a>
                                                            </div>
                                                        </td>
